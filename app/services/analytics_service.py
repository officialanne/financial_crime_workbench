...
def get_risk_kpis() -> Dict[str, Any]:
    ...
    with get_db_connection() as conn:
        ...
        medium_risk_sql = "SELECT COUNT(*) FROM Transactions WHERE Amount BETWEEN 10000 AND 49999"
...
def get_transaction_trends(country: Optional[str] = None, limit: int = 12) -> List[Dict[str, Any]]:
...
def get_dashboard_summary(country: Optional[str] = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "recent_high_risk": transaction_service.list_transactions(limit=10, risk_category="HIGH"),
    }